                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center align-items-center" style="gap: 6px;">
                                <x-btn :href="route('akademik.tahun-ajaran.show', $item->id)" size="sm" class="btn-info" title="Detail" style="margin: 0;">
                                    <i class="fas fa-eye"></i>
                                </x-btn>
                                <x-btn :href="route('akademik.tahun-ajaran.edit', $item->id)" size="sm" class="btn-warning" title="Edit" style="margin: 0;">
                                    <i class="fas fa-edit"></i>
                                </x-btn>
                                <form action="{{ route('akademik.tahun-ajaran.destroy', $item->id) }}" method="POST" class="d-inline" style="margin: 0;">
                                    @csrf
                                    @method('DELETE')
