                        ...
                        <div class="col-md-6">
                            <div class="kanban-filter-buttons">
                                <p class="filter-btn active">
                                    <i class="fas fa-money-bill-wave me-2"></i>Semua Pemasukan
                                </p>
                            </div>
                        </div>
                        <div class="col-md-6 text-end">
                            <div class="add-transaction-buttons">
                                <a href="{{ route('keuangan.pemasukans.create') }}" class="btn btn-success btn-add">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                                    ...
                                    <div class="column-stats mt-2">
                                         <div class="d-flex justify-content-between w-100 px-1">
                                            <div class="text-xs">
                                                ...
                                                <span class="font-weight-bold text-success">Rp{{ number_format($dailyTotal, 0, ',', '.') }}</span>
                                            </div>
                                            <div class="text-xs">
                    ...
                    <div class="text-center py-5">
                        ...
                        <h5 class="text-muted">Tidak ada pemasukan</h5>
                        <p class="text-muted">Tidak ditemukan pemasukan yang sesuai dengan filter yang dipilih.</p>
                        <a href="{{ route('keuangan.pemasukans.index') }}" class="btn btn-primary">
...
<style>
    ...
    .card-source-badge { padding: 5px 12px; border-radius: 20px; font-size: 0.75rem; color: white; font-weight: 700; background: linear-gradient(135deg, #28a745, #20c997); }
