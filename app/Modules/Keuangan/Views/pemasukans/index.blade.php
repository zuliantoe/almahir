                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-md-8 text-md-end">
                            <div class="text-muted small">
                                <span id="incomeCount">{{ $currentPageItems }}</span> pemasukan di {{ $groupedIncomes->count() }} hari
                                @if($searchKeyword)
                                    untuk "{{ $searchKeyword }}"
                                @endif
                                @if($currentMonth != 'all')
                        ...
                        @foreach($paginatedGroups as $date => $dailyIncomes)
                            ...
                            <div class="kanban-column">
                                ...
                                <div class="kanban-column-footer">
                                    <div class="column-total text-success">
                                        <span class="total-text">Total: +Rp{{ number_format($dailyTotal, 0, ',', '.') }}</span>
                                    </div>
                                    <div class="column-count">
                                        <span class="count-text">{{ $dailyIncomes->count() }} pemasukan</span>
                                    </div>
                                </div>
                            </div>
                        @endforeach
