...
<div class="row mb-2">
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{ route('siswa.asrama.kamar.index') }}">Kamar</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <x-card title="Daftar Penghuni Aktif" icon="fas fa-users" class="card-outline card-success">
                <x-slot name="tools">
                    <a href="{{ route('siswa.asrama.kamar.index') }}" class="btn btn-sm btn-secondary shadow-sm">
            ...
            {{-- Riwayat --}}
            <x-card title="Riwayat Penghuni Sebelumnya" icon="fas fa-history" class="card-outline card-secondary collapsed-card mt-3">
                <x-slot name="tools">
