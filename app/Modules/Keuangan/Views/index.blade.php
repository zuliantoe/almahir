...
<div class="container-fluid">
    ...
    <x-card title="Daftar Keuangan" icon="fas fa-list">
        <x-slot name="tools">
            <a href="{{ route('keuangan.create') }}" class="btn btn-primary btn-sm">
                <i class="fas fa-plus mr-1"></i> Tambah Keuangan
            </a>
        </x-slot>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="3" class="text-center text-muted py-4">
                            ...
                            Belum ada data. <a href="{{ route('keuangan.create') }}">Tambah data pertama</a>.
                        </td>
                    </tr>
                    @endforelse
                </tbody>
