            ...
            <x-card title="Tambah Jenis Kegiatan" icon="fas fa-plus-circle" type="primary" outline>
                <form action="{{ route('akademik.jenis-kegiatan.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="deskripsi" rows="4" class="form-control @error('deskripsi') is-invalid @enderror" placeholder="Tambahkan deskripsi kegiatan (opsional)">{{ old('deskripsi') }}</textarea>
