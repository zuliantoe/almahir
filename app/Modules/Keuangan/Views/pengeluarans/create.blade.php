        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0 mb-4 rounded-xl overflow-hidden">
                <div class="card-header py-3 bg-white border-bottom border-light">
                    <h6 class="m-0 font-weight-bold text-danger"><i class="fas fa-plus-circle mr-2"></i> Form Tambah Pengeluaran</h6>
                </div>
                <div class="card-body">
                    <form id="expenseForm" action="{{ route('keuangan.pengeluarans.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <textarea name="deskripsi" 
                                          ...
                                          rows="2"
                                          placeholder="Tambahkan deskripsi pengeluaran">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback ml-2">{{ $message }}</div>
                                @enderror
                            </div>
