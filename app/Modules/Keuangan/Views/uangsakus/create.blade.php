...
@section('title', 'Tambah Uang Saku Baru')

@section('content')
<div class="container-fluid">
    <div class="d-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Uang Saku Baru</h1>
        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0 mb-4 rounded-xl overflow-hidden">
                <div class="card-header py-3 bg-white border-bottom border-light">
                    <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-plus-circle mr-2"></i> Form Tambah Uang Saku</h6>
                </div>
                <div class="card-body">
                    <form id="uangSakuForm" action="{{ route('keuangan.uangsakus.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <textarea name="deskripsi" 
                                          ...
                                          rows="3"
                                          placeholder="Tambahkan deskripsi uang saku">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback ml-2">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            ...
                            <button type="submit" class="btn btn-primary px-5 shadow-sm">
                                <i class="fas fa-save mr-2"></i> Simpan Uang Saku
                            </button>
                        </div>
                    </form>
                </div>
