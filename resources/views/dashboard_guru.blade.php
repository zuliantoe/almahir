...
<div class="container-fluid pb-4">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 mb-4">
            ...
            <div class="card border-0 shadow-sm mb-4 text-center" style="border-radius: 16px; overflow: hidden; border-top: 5px solid #8b5cf6;">
                <div class="card-body p-4">
                    <h5 class="font-weight-bold text-dark mb-2"><i class="fas fa-qrcode text-purple mr-1"></i> Kartu Presensi Digital</h5>
