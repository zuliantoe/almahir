...
<div class="container-fluid">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <x-card title="Form Tambah Pemeliharaan Aset" icon="fas fa-wrench">
                <form action="{{ route('manajemenasetdanasrama.pemeliharaan.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tanggal_pemeliharaan') is-invalid @enderror" id="tanggal_pemeliharaan" name="tanggal_pemeliharaan" value="{{ old('tanggal_pemeliharaan', date('Y-m-d')) }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('deskripsi_pemeliharaan') is-invalid @enderror" id="deskripsi_pemeliharaan" name="deskripsi_pemeliharaan" rows="3" placeholder="Contoh: Penggantian LCD proyektor" required>{{ old('deskripsi_pemeliharaan', request('deskripsi_kerusakan')) }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('biaya') is-invalid @enderror" id="biaya" name="biaya" value="{{ old('biaya', 0) }}" min="0" required>
                        @error('biaya')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
