        ...
        <div class="col-lg-6">
            <div class="card shadow-sm border-0 mb-4 rounded-xl overflow-hidden">
                <div class="card-header py-3 bg-white border-bottom border-light">
                    <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-edit mr-2"></i> Edit Data Sumber</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('keuangan.sumbers.update', $sumber->id) }}" method="POST">
                        @csrf
                        @method('PUT')
